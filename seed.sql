...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th3 12, 2025 lúc 02:45 PM
...
INSERT INTO `bookings` (`bookings_id`, `name`, `tour_id`, `user_id`, `number_of_people`, `total_price`, `address`, `start_location`, `booking_date`, `status`) VALUES
(195, 'Di Di', 4, 3, 2, 2000000, 'Hà Nội', 'Hà Nội', '2024-12-13', 'Đã thanh toán qua ATM'),
(202, 'Di Di', 25, 3, 2, 4000000, 'Hà Nội', 'Hà Nội', '2024-12-13', 'Đã thanh toán với QRcode MoMo'),
(203, 'Di Di', 7, 3, 2, 6000000, 'Hà Nội', 'Hà Nội', '2024-12-13', 'Thanh toán thất bại'),
(205, 'Di Di', 5, 3, 2, 3000000, 'Hà Nội', 'Hà Nội', '2024-12-13', 'Thanh toán trực tiếp'),
(206, 'Vương Thị Diễm', 9, 3, 2, 4400000, 'Hà Nội', 'Hồ Chí Minh', '2024-12-13', 'Chưa thanh toán'),
(210, 'Di Di', 25, 3, 2, 40000, 'Hà Nội', 'Hà Nội', '2024-12-14', 'Thanh toán trực tiếp'),
(211, 'Di Di', 7, 3, 2, 40000, 'Hà Nội', 'Hà Nội', '2024-12-14', 'Đã thanh toán với QRcode MoMo'),
(212, 'Di Di', 3, 3, 2, 40000, 'Hà Nội', 'Hà Nội', '2024-12-14', 'Thanh toán thất bại'),
(213, 'Vương Thị Diễm', 25, 3, 1, 20000, 'Hà Nội', 'Hà Nội', '2025-03-11', 'Đã thanh toán với QRcode MoMo'),
(214, 'Vương Thị Diễm', 4, 3, 1, 20000, 'Hà Nội', 'Hà Nội', '2025-03-11', 'Thanh toán trực tiếp'),
(215, 'Vương Thị Diễm', 4, 2, 2, 40000, 'Hà Nội', 'Hà Nội', '2025-03-11', 'Thanh toán trực tiếp');
...
(3, 'Vương Thị Diễm', 'diem@gmail.com', '0921059333', 'tin nhắn', '2024-12-12'),
(21, 'Vương Thị Diễm', 'diem@gmail.com', '0921059333', 'Test liên hệ', '2024-12-13');
...
INSERT INTO `reviews` (`reviews_id`, `tour_id`, `user_id`, `comment`, `created_at`) VALUES
(3, 8, 2, 'good', '2024-11-29'),
(16, 7, 2, 'Tour này hấp dẫn quá', '2024-12-07'),
(17, 10, 1, 'Thú vị', '2024-12-11');
...
INSERT INTO `tour` (`id`, `tour_name`, `location`, `vehicle`, `region`, `start_location`, `description`, `price`, `duration`, `image`, `start_date`, `end_date`, `created_at`, `tour_status`, `image1`, `image2`, `image3`, `image4`) VALUES
(3, 'Hà Giang - Sông Nho Quế hùng vĩ', 'Hà Giang', 'Xe ô tô, xe máy', 'Miền Bắc', 'Hà Nội', 'Tour Hà Giang 3 ngày 2 đêm từ Hà Nội vào dịp Tết Nguyên Đán 2025 sẽ mang đến cho bạn cơ hội trải nghiệm cảnh đẹp hùng vĩ của miền núi phía Bắc. Đây là hành trình lý tưởng để tận hưởng kỳ nghỉ Tết, khám phá văn hóa và thiên nhiên vùng cao, đồng thời tránh xa sự ồn ào của thành phố.', 20000, '3N2Đ', 'hagiang.jpg', '2024-11-22', '2024-11-24', '0000-00-00', 'hot', 'hagiang1.jpg', 'hagiang2.jpeg', 'hagiang3.webp', 'hagiang4.jpg'),
(4, 'Mộc Châu - Sơn La - Điện Biên - Lai Châu - Sapa', 'Tây Bắc', 'Xe ô tô, xe máy', 'Miền Bắc', 'Hà Nội', 'Tour du xuân Tây Bắc qua Mộc Châu - Sơn La - Điện Biên - Lai Châu - Sapa 5 ngày 4 đêm dịp Tết Nguyên Đán 2025 bạn sẽ được đắm mình trong không gian của núi non, những bản làng bình dị, và hòa mình vào sắc xuân rực rỡ trời Tây Bắc. ', 20000, '5N4Đ', 'sapa.jpg', '2024-11-23', '2024-11-28', '0000-00-00', 'hot', 'sapa1.jpg', 'sapa2.jpg', 'sapa3.jpg', 'sapa4.jpg'),
(5, 'Săn mây Tà Xùa - Bắc Yên ', 'Bắc Yên, Sơn La', 'Xe ô tô, xe máy', 'Miền Bắc', 'Hà Nội', 'Tour săn mây Tà Xùa - Bắc Yên 2 ngày 1 đêm vào dịp Tết Nguyên Đán 2025 sẽ đưa bạn đến với một vùng đất hoang sơ và hùng vĩ, nơi bạn có thể ngắm nhìn những biển mây trải dài như vô tận. Chuyến đi là cơ hội lý tưởng để tạm rời xa sự nhộn nhịp của thành phố, hòa mình vào không gian thanh bình và trong lành của núi rừng Tây Bắc.', 20000, '2N1Đ', 'taxua.jpg', '2024-11-30', '2024-12-03', '0000-00-00', 'hot', 'taxua1.jpg', 'taxua2.jpg', 'taxua3.jpg', 'taxua4.jpg'),
(6, 'Đà Nẵng - Hội An - Sơn Trà - Bà Nà Hills', 'Đà Nẵng', 'Xe ô tô', 'Miền Nam', 'Hồ Chí Minh', 'Tour Đà Nẵng - Hội An - Sơn Trà - Bà Nà Hills 4 ngày 3 đêm của PYS Travel sẽ mang đến cho bạn một trải nghiệm tuyệt vời với những địa danh nổi tiếng cùng với vẻ đẹp tự nhiên tuyệt vời và văn hóa ẩm thực phong phú của hai thành phố này.', 20000, '4N3Đ', 'danang.jpg', '2024-11-30', '2024-12-04', '0000-00-00', 'hot', 'danang1.jpg', 'danang2.jpg', 'danang3.jpg', 'danang4.jpg'),
(7, 'Quy Nhơn - Phú Yên', 'Quy Nhơn', 'Xe ô tô, tàu', 'Miền Nam', 'Hồ Chí Minh', 'Tour Quy Nhơn- Phú Yên 4 ngày 3 đêm cùng PYS Travel sẽ cùng quý khách khám phá vẻ đẹp mà tạo hóa đã ban tặng cho Quy Nhơn nơi được mệnh danh \"thiên đường Maldives\" của Việt Nam\r\n\r\nQuy Nhơn hấp dẫn du khách bởi sự thanh bình, yên tĩnh của những bãi biển hoang sơ chưa bị thương mại hóa cao. Sẽ là một trải nghiệm tuyệt vời dành cho những ai đam mê cung đường đầy nắng, gió và kiến tạo kỳ vĩ của thiên nhiên.', 20000, '4N3Đ', 'quynhon.webp', '2024-11-30', '2024-12-04', '0000-00-00', 'hot', 'quynhon1.jpg', 'quynhon2.jpg', 'quynhon3.jpg', 'quynhon4.jpg'),
(8, 'Cần Thơ - Côn Đảo', 'Cần Thơ', 'Xe ô tô, tàu', 'Miền Nam', 'Hồ Chí Minh', 'Tạo hóa đã ban tặng cho miền Tây cái đẹp mộc mạc mà nên thơ, với những cánh đồng xanh bát ngát, những miệt vườn sai quả, những ngả đường trĩu nặng phù sa. Đặc biệt, du khách sẽ được xuôi về miền sông nước hữu tình này để chu du, thưởng ngoạn và trải nghiệm những điều bình dị, chân phương.\r\n\r\nKhám phá Côn Đảo – hòn đảo từng được mệnh danh là ‘Địa ngục trần gian’, nơi ghi dấu những địa danh thấm đẫm máu đào của những người con yêu nước. Nơi đây cũng gây ngỡ ngàng khi mang vẻ đẹp tuyệt vời và bình yên đến lạ, níu chân du khách phương xa', 20000, '5N4Đ', 'cantho.jpg', '2024-12-18', '2024-12-22', '0000-00-00', 'hot', 'cantho1.jpg', 'cantho2.jpg', 'cantho3.jpg', 'cantho4.jpg'),
(9, 'Phố cổ Hội An', 'Hội An, Đà Nẵng', 'Xe ô tô', 'Miền Nam', 'Hồ Chí Minh', 'Cùng với bao biến cố thăng trầm của lịch sử, phố cổ Hội An vẫn giữ những nét đẹp xưa cổ trầm mặc rêu phong như chính nét bình dị trong tính cách, tâm hồn của người dân địa phương.', 20000, '3N2Đ', 'hoian.webp', '2024-11-26', '2024-11-29', '0000-00-00', 'famous', 'hoian1.jpg', 'hoian2.jpg', 'hoian3.jpg', 'hoian4.jpg'),
(10, 'Làng Hoa Sa Đéc', 'Đồng Tháp', 'Xe ô tô, thuyền', 'Miền Nam', 'Hồ Chí Minh', 'Thủ phủ hoa kiểng miền Tây, sắc màu rực rỡ quanh năm. Trải nghiệm văn hóa miền Tây và thưởng thức đặc sản trứ danh.', 20000, '3N2Đ', 'langhoa.jpg', '2024-11-29', '2024-11-21', '0000-00-00', 'famous', 'dongthap1.jpg', 'dongthap2.jpg', 'dongthap3.jpg', 'dongthap4.jpg'),
(16, 'Mù Cang Chải', 'Yên Bái', 'Xe ô tô, xe máy', 'Miền Bắc', 'Hà Nội', 'Mù Cang Chải nổi bật với những danh thắng nổi bật như ruộng bậc thang, thác nước hùng vĩ và những bản làng độc đáo.', 20000, '3N2Đ', 'mucangchai.jpg', '2024-11-26', '2024-11-29', '0000-00-00', 'famous', 'mucangchai1.jpg', 'mucangchai2.jpg', 'mucangchai3.jpg', 'mucangchai4.jpg'),
(25, 'Hồ Ba Bể - Thác Bản Giốc', 'Cao Bằng', 'Ô tô', 'Miền Bắc', 'Hà Nội', 'mo ta', 20000, '2N1Đ', 'cantho3.jpg', '2024-12-07', '2024-12-09', '2025-02-22', 'hot', 'cantho4.jpg', 'caobang1.jpg', 'caobang2.jpg', 'caobang3.jpg');
...
(1, 'admin', 'admin123', 'admin@gmail.com', 'admin', '0987654321', 'admin'),
(2, 'client', 'client123', 'client@gmail.com', 'client', '0987654321', 'client'),
(3, 'diem', '123456', 'diem@gmail.com', 'diemm', '0987654321', 'client');
...
--
ALTER TABLE `bookings`
  MODIFY `bookings_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
...
--
ALTER TABLE `reviews`
  MODIFY `reviews_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
